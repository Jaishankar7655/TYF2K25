...
function Literary() {
  ...
  const literaryEvents = [
    { id: 14, name: "POSTER PRESENTATION", rules: ["THEME:- WOMENS DAY.", "USE GRAPHICS & ILLUSTRATIONS.", "ONLY HAND MADE POSTER WILL BE CONSIDERED.", "PRESENTATION TIME LIMIT FOR EXPLAINATION WILL BE 2 MIN.", "POSTER SIZE IS A0 SIZE(33* 46 INCH).", "POSTERS HAS TO BE PRE HAND MADE"], date: "7TH MARCH, 3:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "🖼️" },
    { id: 15, name: "BECHO TO JAANE", rules: ["SELLING MATERIAL WILL BE PROVIDED BY INSTITUTION.", "TIME LIMIT WILL BE HALF N HOUR."], date: "7TH MARCH, 2:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "🛍️" },
    { id: 16, name: "IPL AUCATION", rules: ["TEAM SHOULD HAVE 3 MEMBERS.", "BIDDING HAS TO BE DONE WITHIN ASSIGN BUDGET"], date: "8TH MARCH, 11:00 AM", fees: "Rs 150 PER TEAM", prizes: "TROPHY FOR WINNING AND RUNNERUP TEAM", emoji: "🏏" },
    { id: 17, name: "POETRY (KAVI KOSH)", rules: ["VULGAR WRITING IS NOT ALLOWED."], date: "8TH MARCH, 1:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "✍️" },
    { id: 18, name: "EXTEMPORE", rules: ["PARTICIPANTS WILL BE GIVEN A TANDOM TOPIC AND THEY HAVE TO SPEAK ON THAT TOPIC.", "PERTICULAR TIME WILL BE GIVEN TO SPEAK.", "PARTICIPANTS WILL NOT BE ALLOWED TO PREPARE SPEECH IN ADVANCE."], date: "8TH MARCH, 2:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "🎙️" },
    { id: 19, name: "MIND MARATHON", rules: ["THERE WILL BE 4 ROUNDS.", "QUESTIONS WILL BE ON GENERAL SCIENCE, GK AND CURRENT AFFAIRS.", "TIME LIMIT WILL BE THERE FOR FIRST"], date: "9TH MARCH, 11:00 AM", fees: "RS 70 DUO", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "🧠" },
    { id: 20, name: "AD MAD SHOW", rules: ["MAX FOUR MEMBER PER TEAM.", "TIME LIMIT WILL BE 2 MIN.", "ONE AD HAS TO BE PREPARED IN ADVANCED FOR ROUND ONE."], date: "9TH MARCH, 11:00 AM", fees: "Rs100 PER TEAM", prizes: "TROPHY FOR 1ST, 2ND & 3RD ", emoji: "📺" },
    { id: 21, name: "DESIGNER CUT", rules: ["MAX TWO MEMBER PER TEAM.", "NEWSPAPER IS PROVIDED BY INSTITUTION.", "CUT AND DESIGN WILL BE DONE IN THE GIVEN TIME.", "DRESS CAN BE WAREABLE AND DECENT.", "NO PRE-PREPARED DRESS WILL BE ALLOWED."], date: "9TH MARCH, 11:00 AM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "✂️" },
  ];
