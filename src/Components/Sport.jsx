  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="bg-gray-50 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Ready to Compete?</h2>
        <p className="text-gray-600 mb-6">Register now to participate in these exciting sports events!</p>
        <button
          onClick={handleRegister}
