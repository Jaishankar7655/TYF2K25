      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {allEvents.map((event, index) => (
          <Link
            key={index}
            to={event.path}
            className={`group flex flex-col items-center justify-center p-8 bg-dark-card/80 border-2 ${event.borderColor} rounded-2xl hover:-translate-y-2 transition-all duration-400 ${event.hoverBorder} ${event.glow} backdrop-blur-xl`}
          >
