...
function AllEvents() {
  const allEvents = [
    ...
    { name: "SAC Committee", path: "/sac", icon: <Star className="w-10 h-10 mb-3" />, color: "text-green-400", borderColor: "border-green-400/30", hoverBorder: "hover:border-green-400", glow: "hover:shadow-[0_0_25px_rgba(74,222,128,0.2)]", emoji: "🌟" },
  ];
