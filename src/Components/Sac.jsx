...
function Sac() {
  ...
  const sacEvents = [
      ...
      { id: 2, name: "Spoon Tie-Knot Challenge", rules: ["Perform the challenge in given time."], date: "6 APRIL 2026", venue: "SAC ADDA", fees: "Rs 50", prizes: "Surprise Reward", emoji: "🥄" },
      { id: 3, name: "Arm Wrestling (SAC)", rules: ["Standard rules apply."], date: "6 APRIL 2026", venue: "SAC ADDA", fees: "Rs 50", prizes: "Surprise Reward", emoji: "✊" },
      { id: 4, name: "Blind Fold Challenge", rules: ["Follow the guided route."], date: "6 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🙈" },
      { id: 5, name: "Cup Pyramid", rules: ["Fastest to build wins."], date: "6 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🥤" },
      { id: 6, name: "Dare to Drink", rules: ["Mystery drink challenge."], date: "6 APRIL 2026", venue: "SAC ADDA", fees: "Rs 50", prizes: "Surprise Reward", emoji: "🍹" },
      { id: 7, name: "Plank / Weight Add-On Challenge", rules: ["Standard rules apply."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🏋️" },
      { id: 8, name: "Poetry", rules: ["Any topic."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "✍️" },
      { id: 9, name: "Bottle Flip", rules: ["Maximum consecutive flips win."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🍾" },
      { id: 10, name: "Thug of War (Per Team)", rules: ["Max 10 per team."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Rs 300", prizes: "Surprise Reward", emoji: "🪢" },
      { id: 11, name: "Teacher's Ramp Walk", rules: ["Exclusive for teachers."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🧑‍🏫" },
      { id: 12, name: "Dance-Freeze Challenge", rules: ["Freeze when music stops."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "🧊" },
      { id: 13, name: "Paper Folding Dance", rules: ["Dance and stay on the paper."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Free", prizes: "Surprise Reward", emoji: "📰" },
      { id: 14, name: "Truba Roadies", rules: ["Task based event."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "100", prizes: "Surprise Reward", emoji: "🏍️" },
      { id: 15, name: "Sign - Walk Game", rules: ["Follow the instructions."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Rs 50", prizes: "Surprise Reward", emoji: "🚶‍♂️" },
      { id: 16, name: "Cricket Circle Game", rules: ["Hit boundaries."], date: "7 APRIL 2026", venue: "SAC ADDA", fees: "Rs 100", prizes: "Surprise Reward", emoji: "🏏" },
  ];
