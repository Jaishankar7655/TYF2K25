...
function Technical() {
  ...
  const technicalEvents = [
    { id: 1, name: "COMMERCE QUIZ", rules: ["THERE WILL BE THREE ROUNDS (MCQ, PRESENTATION, RAPID FIRE).", "TIME LIMIT WILL BE THERE FOR EACH ROUND.", "POINTS FOR CORRECT ANSWERS AND PENALTIES FOR INCORRECT."], date: "7TH MARCH, 11:00 AM", fees: "RS 100 DUO", prizes: "TROPHY FOR WINNING AND RUNNERUP DUO", emoji: "📊" },
    { id: 2, name: "BUDDHI VIMARSH", rules: ["MAXIMUM 6 SLIDES CAN BE THERE.", "IT SHOULD BE RELATED TO PHARMACY TOPIC.", "EXPLANATION SHOULD BE SHORT AND SIMPLE."], date: "7TH MARCH, 2:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "💊" },
    { id: 3, name: "TECH PAPER PRESENTATION", rules: ["SINGLE ROUND WILL BE HELD.", "PRESENTATION SHOULD BE UNDER 10 MIN."], date: "7TH MARCH, 2:00 PM", fees: "RS 100 SINGLE /DUO", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "📝" },
    { id: 6, name: "TECHNICAL QUIZ (TECH TITAN)", rules: ["TOTAL 5 SECTION WILL BE THERE.", "QUESTION ATTEMPTATION SHOULD BE MANDATORY.", "ALL THE QUESTION WILL BE MULTIPLE CHOICE"], date: "8TH MARCH, 2:00 PM", fees: "Rs 50", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "🧪" },
    { id: 7, name: "CODE ENCOUNTER", rules: ["THERE WILL BE TWO ROUNDS (1ST WILL BE CHOOSE THE CORRECT ANSWER & 2ND WILL BE CODE EXECUTION)"], date: "9TH MARCH, 11:00 AM", fees: "Rs 100", prizes: "TROPHY FOR WINNER AND RUNNERUP", emoji: "💻" },
    { id: 5, name: "CURE CELEBRATION", rules: ["IT WILL BE OF TWO ROUNDS. (SIMPLE SYRUP IN FIRST ROUND & EFFERVESCENT POWDER IS FOR SECOND ROUND)"], date: "8TH MARCH, 10:30 AM", fees: "RS 100 DUO", prizes: "TROPHY FOR WINNING AND RUNNERUP DUO", emoji: "⚗️" },
  ];
